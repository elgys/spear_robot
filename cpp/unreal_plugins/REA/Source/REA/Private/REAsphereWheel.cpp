...
UREAsphereWheel::UREAsphereWheel()
{
    std::cout << "[SPEAR | REAsphereWheel.cpp] REAsphereWheel::UReasphereWheel" << std::endl;

    if (!Config::s_initialized_) {
        return;
    }

    ConstructorHelpers::FObjectFinder<UStaticMesh> collision_mesh(TEXT("/Engine/EngineMeshes/Sphere"));
...
UREAsphereWheel::~UREAsphereWheel()
{
    std::cout << "[SPEAR | REAsphereWheel.cpp] UREAsphereWheel::~UREAsphereWheel" << std::endl;
}
END_SUPPRESS_COMPILER_WARNINGS
